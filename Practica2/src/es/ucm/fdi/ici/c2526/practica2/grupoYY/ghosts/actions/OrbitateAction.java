...
public class OrbitateAction implements Action {
	...
	public MOVE execute(Game game) {
        if (game.doesGhostRequireAction(ghost))        //if it requires an action
        {
           ...
           this.orbitDistance = (game.getGhostEdibleTime(this.ghost)/1.5); //Initial distance is 101 because 100 is the limit when pacMan can eat us before die so in the end when edible time is 0 the limit will be 1
