...
public class GhostsPasoAHunter1 implements Transition  {
	...
	GhostInfo gi;
	int references;
	public GhostsPasoAHunter1(GHOST ghost,GhostInfo gi,int ref) {
		super();
		this.ghost = ghost;
		this.gi = gi;
		this.references = ref;
	...
	public boolean evaluate(Input in) {
		...
		return (gi.getMyGhostPriority(ghost) == GHOSTTYPE.HUNTER1);
		}
	...
	public String toString() {
		return this.ghost+" Hunter1 " + this.references;
	}
